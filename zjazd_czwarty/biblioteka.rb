...
book2 = Book.new("Harry Potter", "Rowling")
book3 = Book.new("Władca Pierścieni", "Tolkien")
book4 = Book.new("Gra o Tron", "Martin")
book5 = Book.new("Igrzyska Śmierci", "Collins")
book6 = Book.new("Zmierzch", "Meyer")
book7 = Book.new("Krzyżacy", "Sienkiewicz")
book8 = Book.new("Chłopi", "Reymont")
book9 = Book.new("Lalka", "Prus")
book10 = Book.new("Przedwiośnie", "Zeromski")
